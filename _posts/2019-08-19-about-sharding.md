...
25% probability of a node being evil <img style=float: left; src="https://github.com/coinweb/technical-docs/blob/master/assets/img/25percentevilnodes.svg" width="400" height="400" > 
10% probability of a node being evil <img style=float: right; src="https://github.com/coinweb/technical-docs/blob/master/assets/img/25percentevilnodes.svg" width="400" height="400">
1% probability of a node being evil <img style=float: left; src="https://github.com/coinweb/technical-docs/blob/master/assets/img/25percentevilnodes.svg" width="400" height="400">
0.1% probability of a node being evil <img style=float:right src="https://github.com/coinweb/technical-docs/blob/master/assets/img/25percentevilnodes.svg" width="400" height="400">
