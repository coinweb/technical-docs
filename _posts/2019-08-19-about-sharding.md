...
|-------------------------------------------|-------------------------------------------|
| ![]({{site.baseurl}}/assets/img/25percentevilnodes.png) | ![]({{site.baseurl}}/assets/img/10percentevilnodes.png) |

|     1% probability of a node being evil   |   0.1% probability of a node being evil   |
|-------------------------------------------|-------------------------------------------|
| ![]({{site.baseurl}}/assets/img/1percentevilnodes.png) | ![]({{site.baseurl}}/assets/img/0.1percentevilnodes.png) |
